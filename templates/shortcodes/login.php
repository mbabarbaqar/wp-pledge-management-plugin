 ...
 *
 * Override this template by copying it to yourtheme/hspg/shortcodes/login.php
 *
 * @author  Eric Daams
...
<div class="hs-login-form">
	 ...
	 */
	do_action( 'hs_login_form_before', $view_args );
	...
	<p>
		...
		<?php endif ?>
		<a href="<?php echo esc_url( hs_get_permalink( 'forgot_password_page' ) ); ?>"><?php _e( 'Forgot Password', 'hspg' ); ?></a>
	</p>
	<?php
	 ...
	 * @param array $view_args All args passed to template.
	 */
	do_action( 'hs_login_form_after', $view_args )
