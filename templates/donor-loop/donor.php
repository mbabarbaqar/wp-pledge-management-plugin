 ...
 *
 * Override this template by copying it to yourtheme/hspg/donor-loop/donor.php
 *
...
<li class="donor">
	 ...
	 */
	do_action( 'hs_donor_loop_before_donor', $donor, $view_args );
	...
	?>
		...
		<?php
			 ...
			 * @param array  $view_args View arguments.
			 */
			echo apply_filters( 'hs_donor_loop_donor_name', $donor->get_name(), $view_args );
		?>
		</p>
	<?php
	endif;
	...
	?>
		...
		<?php
			 ...
			 * @param array  $view_args View arguments.
			 */
			echo apply_filters( 'hs_donor_loop_donor_location', $donor->get_location(), $view_args );
		?>
		</div>
	<?php
	endif;
	...
	?>
		...
		<?php
			 ...
			 * @param array  $view_args View arguments.
			 */
			echo apply_filters( 'hs_donor_loop_donor_amount', hs_format_money( $donor->get_amount( $campaign_id ) ), $view_args );
		?>
		</div>
	<?php
	endif;
	 ...
	 * @param array            $view_args View arguments.
	 */
	do_action( 'hs_donor_loop_after_donor', $donor, $view_args );
	?>
