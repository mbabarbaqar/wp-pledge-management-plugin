 ...
 *
 * Override this template by copying it to yourtheme/hspg/account/email-verified.php
 *
 * @author  Eric Daams
...
?>
<p><?php _e( 'Your email address has been verified.', 'hspg' ) ?></p>
<p><a href="<?php home_url() ?>"><?php _e( 'Return home', 'hspg' ) ?></a></p>