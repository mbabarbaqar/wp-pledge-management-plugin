 ...
 *
 * Override this template by copying it to yourtheme/hspg/cc-expiration.php
 *
 * @author  Studio 164a
...
<div id="hs_field_<?php echo $field['key'] ?>" class="<?php echo $classes ?>">
	<fieldset class="hs-fieldset-field-wrapper">
		...
		<?php endif ?>
		<select name="<?php echo $field['key'] ?>[month]" class="month" aria-describedby="hs_field_<?php echo esc_attr( $field['key'] ) ?>_label">
		...
		<select name="<?php echo $field['key'] ?>[year]" class="year" aria-describedby="hs_field_<?php echo esc_attr( $field['key'] ) ?>_label">
			<?php for ( $i = 0; $i < 15; $i++ ) :
				$year = $current_year + $i;
				?>
	...
	</fieldset><!-- .hs-field-wrapper -->
</div><!-- #hs_field_<?php echo $field['key'] ?> -->
