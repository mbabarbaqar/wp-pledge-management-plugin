...
<div id="hs_field_<?php echo $field['key'] ?>" class="<?php echo $classes ?>">
	...
	<?php endif ?>
	<textarea name="<?php echo esc_attr( $field['key'] ) ?>" id="hs_field_<?php echo $field['key'] ?>_element" <?php echo hs_get_arbitrary_attributes( $field ) ?>><?php echo esc_textarea( stripslashes( $value ) ) ?></textarea>
</div>