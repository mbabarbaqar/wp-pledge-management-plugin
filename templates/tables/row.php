 ...
 *
 * Override this template by copying it to yourtheme/hspg/tables/header-row.php
 *
 * @author  Studio 164a
...
<tr>
    ...
    <td class="hs-table-cell-<?php echo esc_attr( $key ) ?>"><?php echo array_key_exists( $key, $data ) ? $data[ $key ] : '' ?></td>
    <?php endforeach ?>
</tr>
