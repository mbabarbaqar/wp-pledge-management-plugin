 ...
 *
 * Override this template by copying it to yourtheme/hspg/widgets/campaigns.php
 *
...
$thumbnail_size = apply_filters( 'hs_campaign_widget_thumbnail_size', 'medium' );
...
while ( $campaigns->have_posts() ) :
	...
	$campaign = new Hs_Campaign( get_the_ID() );
	?>
	<li class="campaign">
		<?php
