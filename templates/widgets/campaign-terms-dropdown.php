 ...
 *
 * Override this template by copying it to yourtheme/hspg/widgets/campaign-terms.php
 *
...
$dropdown_args = array(
	...
	'id'               => $dropdown_id,
	'show_option_none' => sprintf( _x( 'Select %s', 'select campaign category/tag', 'hspg' ), ucwords( str_replace( '_', ' ', $taxonomy ) ) ),
	'value_field'      => 'slug',
