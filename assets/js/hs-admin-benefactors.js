( function($){
    var add_campaign_benefactor = function( $el ) {
        ...
        $.ajax({
            ...
            success: function( response ) {
                ...
                CHARITABLE_ADMIN.SetupDatepicker( $( '#campaign_benefactor__' + idx + ' .hs-datepicker' ) );
            }
        }).fail(function (data) {
    ...
    var delete_campaign_benefactor = function( $el ) {
        var $block = $el.parents( '.hs-benefactor' ),
            data = {
    ...
    $(document).ready( function() {
        ...
        $('body').on( 'click', '.hs-benefactor-form-cancel', function() {
