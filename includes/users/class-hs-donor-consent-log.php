 ...
 *
 * @package   Hspg/Classes/Hs_Donor_Consent_Log
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Donor_Consent_Log' ) ) :

	/**
	 * Hs_Donor_Consent_Log
	 *
	 * @since 1.6.0
	 */
	class Hs_Donor_Consent_Log {
		...
		public function add( $consent_given, $consent_statement ) {
			 ...
			 * @param int     $donor_id          The donor ID.
			 */
			do_action( 'hs_donor_contact_consent_changed', $consent_changed, $statement_changed, $this->donor_id );
