<?php
/**
 * Hs_Campaign_Field model.
 *
 * @package   Hspg/Classes/Hs_Campaign_Field
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Campaign_Field' ) ) :
	 ...
	 */
	class Hs_Campaign_Field extends Hs_Field implements Hs_Field_Interface {
		...
		public function sanitize_admin_form( $value ) {
			return $this->sanitize_form_arg(
				...
				array(
					...
					'default'   => '',
					'attrs'     => array(),
					'section'   => hspg()->campaign_fields()->get_default_section( 'admin' ),
				)
			);
		}
	}
