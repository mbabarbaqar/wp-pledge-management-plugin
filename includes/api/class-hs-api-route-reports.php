 ...
 *
 * @package   Hspg/Classes/Hs_API_Route_Reports
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_API_Route_Reports' ) ) :

	/**
	 * Hs_API_Route_Reports
	 *
	 * @since 1.6.0
	 */
	class Hs_API_Route_Reports extends Hs_API_Route {
		...
		public function register_routes() {
			register_rest_route(
				...
				array(
					...
					'permission_callback' => array( $this, 'user_can_get_hs_reports' ),
				)
			);
		...
		public function get_reports() {
			return rest_ensure_response(
				array(
					'slug'        => 'donations',
					'description' => __( 'List of donation reports.', 'hspg' ),
					'_links'      => array(
						'self' => array(
