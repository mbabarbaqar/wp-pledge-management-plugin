 ...
 *
 * @version   1.5.0
 * @package   Hspg/Interfaces/Hs_Form_View_Interface
 * @author    Eric Daams
...
if ( ! interface_exists( 'Hs_Form_View_Interface' ) ) :

    /**
     * Hs_Form_View_Interface interface.
     *
     * @since 1.5.0
     */
    interface Hs_Form_View_Interface {
