 ...
 *
 * @package   Hspg/Interfaces/Hs_Admin_Actions_Interface
 * @version   1.5.0
 * @author    Eric Daams
...
if ( ! interface_exists( 'Hs_Admin_Actions_Interface' ) ) :

    /**
     * Hs_Admin_Actions_Interface
     *
     * @since 1.5.0
     */
    interface Hs_Admin_Actions_Interface {
