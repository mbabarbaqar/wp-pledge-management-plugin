<?php
/**
 * Hspg Email interface.
 *
 * This defines a strict interface that emails must implement.
 *
 * @version   1.5.0
 * @package   Hspg/Interfaces/Hs_Email_Interface
 * @author    Eric Daams
...
if ( ! interface_exists( 'Hs_Email_Interface' ) ) :

    /**
     * Hs_Email_Interface interface.
     *
     * @since 1.2.0
     */
    interface Hs_Email_Interface {
