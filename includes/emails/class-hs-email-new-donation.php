 ...
 *
 * @version     1.0.0
 * @package     Hspg/Classes/Hs_Email_New_Donation
 * @author     HCS
...
if ( ! class_exists( 'Hs_Email_New_Donation' ) ) :
	 ...
	 * @since   1.0.0
	 */
	class Hs_Email_New_Donation extends Hs_Email {
		...
		public function __construct( $objects = array() ) {
			 ...
			 * @param string $name
			 */
			$this->name = apply_filters( 'hs_email_new_donation_name', __( 'Admin: New Donation Notification', 'hspg' ) );
		}
		...
		public static function resend( $object_id, $args = array() ) {
			...
			$email = new Hs_Email_New_Donation( array(
				'donation' => $donation,
			) );
		...
		public static function can_be_resent( $object_id, $args = array() ) {
			$resendable = hs_is_approved_status( get_post_status( $object_id ) );
			 ...
			 * @param array   $args       Mixed set of arguments.
			 */
			return apply_filters( 'hs_can_resend_new_donation_email', $resendable, $object_id, $args );
		}
		...
		protected function get_default_subject() {
			return __( 'You have received a new donation', 'hspg' );
		}
		...
		protected function get_default_headline() {
			 ...
			 * @param Hs_Email_New_Donation $email    The email object.
			 */
			return apply_filters( 'hs_email_donation_receipt_default_headline', __( 'New Donation', 'hspg' ), $this );
		}
		...
		protected function get_default_body() {
			ob_start();
?>
<p><?php _e( '[hs_email show=donor] has just made a donation!', 'hspg' ) ?></p>
...
<?php
			 ...
			 * @param Hs_Email_New_Donation $email The email object.
			 */
			return apply_filters( 'hs_email_new_donation_default_body', ob_get_clean(), $this );
		}
	}
