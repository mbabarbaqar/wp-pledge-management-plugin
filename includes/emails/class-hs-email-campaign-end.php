 ...
 *
 * @version     1.1.0
 * @package     Hspg/Classes/Hs_Email_Campaign_End
 * @author     HCS
...
if ( ! class_exists( 'Hs_Email_Campaign_End' ) ) :
	 ...
	 * @since  1.1.0
	 */
	class Hs_Email_Campaign_End extends Hs_Email {
		 ...
		 * @since 1.1.0
		 *
		 * @param mixed[] $objects Set of objects, including an instance of `Hs_Campaign`.
		 */
		public function __construct( $objects = array() ) {
			 ...
			 * @param Hs_Email_Campaign_End $email The email object.
			 */
			$this->name = apply_filters( 'hs_email_campaign_end_name', __( 'Admin: Campaign Ended Notification', 'hspg' ) );
		}
		...
		public static function send_with_campaign_id( $campaign_id ) {
			...
			$email = new Hs_Email_Campaign_End( array(
				'campaign' => new Hs_Campaign( $campaign_id ),
			) );
		...
		protected function get_default_subject() {
			return __( 'A campaign has finished', 'hspg' );
		}
		...
		protected function get_default_headline() {
			 ...
			 * @param Hs_Email_Campaign_End $email The email object.
			 */
			return apply_filters( 'hs_email_campaign_end_default_headline', __( 'Campaign has ended', 'hspg' ), $this );
		}
...
<p>
	<?php
		sprintf(
			...
			__( '%1$s by %2$s finished on %3$s.', 'hspg' ),
			'[hs_email show=campaign_title]',
			'[hs_email show=campaign_creator]',
			'[hs_email show=campaign_end_date]'
		);
	?>
</p>
<p>[hs_email show=campaign_achieved_goal success="<?php _e( 'The campaign achieved its fundraising goal.', 'hspg' ); ?>" failure="<?php _e( 'The campaign did not reach its fundraising goal.', 'hspg' ); ?>"]</p>
<table>
<tbody>
<tr>
	<th><?php _e( 'Amount raised', 'hspg' ); ?></th>
	<td>[hs_email show=campaign_donated_amount]</td>
</tr>
<tr>
	<th><?php _e( 'Number of donors', 'hspg' ); ?></th>
	<td>[hs_email show=campaign_donor_count]</td>
</tr>
<tr>
	<th><?php _e( 'Fundraising goal', 'hspg' ); ?></th>
	<td>[hs_email show=campaign_goal]</td>
</tr>
</tbody>
</table>
<?php
			 ...
			 * @param Hs_Email_Campaign_End $email The email object.
			 */
			return apply_filters( 'hs_email_campaign_end_default_body', $body, $this );
		}
	}
