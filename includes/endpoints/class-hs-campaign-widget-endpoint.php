 ...
 * Donate endpoint.
 *
 * @package   Hspg/Classes/Hs_Campaign_Widget_Endpoint
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Campaign_Widget_Endpoint' ) ) :

	/**
	 * Hs_Campaign_Widget_Endpoint
	 *
	 * @since 1.5.0
	 */
	class Hs_Campaign_Widget_Endpoint extends Hs_Endpoint {
		...
		public function is_page( $args = array() ) {
			...
			return $wp_query->is_main_query()
				...
				&& $wp_query->is_singular( Hspg::CAMPAIGN_POST_TYPE );
		}
		...
		public function get_template( $template ) {
			do_action( 'hs_is_widget' );

			add_filter( 'show_admin_bar', '__return_false' );
			add_action( 'wp_head', 'hs_hide_admin_bar' );

			return apply_filters( 'hs_widget_page_template', 'campaign-widget.php' );
		}
	}
