 ...
 *
 * @package   Hspg/Classes/Hs_Donation_Processing_Endpoint
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Donation_Processing_Endpoint' ) ) :

	/**
	 * Hs_Donation_Processing_Endpoint
	 *
	 * @since 1.5.0
	 */
	class Hs_Donation_Processing_Endpoint extends Hs_Endpoint {
		...
		public function get_template( $template ) {
			new Hs_Ghost_Page(
				...
				array(
					'title'   => __( 'Thank you for your donation', 'hspg' ),
					'content' => sprintf( '<p>%s</p>', __( 'You will shortly be redirected to the payment gateway to complete your donation.', 'hspg' ) ),
				)
			);
		...
		public function get_content( $content ) {
			...
			return apply_filters( 'hs_processing_donation_' . $donation->get_gateway(), $content, $donation );
		}
