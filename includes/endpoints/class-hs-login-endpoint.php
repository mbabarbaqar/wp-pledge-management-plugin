 ...
 * Login endpoint.
 *
 * @package   Hspg/Classes/Hs_Login_Endpoint
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Login_Endpoint' ) ) :
	 ...
	 * @since 1.5.0
	 */
	class Hs_Login_Endpoint extends Hs_Endpoint {
		...
		public function get_page_url( $args = array() ) {
			$page = hs_get_option( 'login_page', 'wp' );
		...
		public function is_page( $args = array() ) {
			...
			if ( 'wp' == $page ) {
				return $strict ? false : wp_login_url() == hs_get_current_url();
			}
		...
		public function nav_menu_object() {
			return $this->get_nav_menu_object( __( 'Log In', 'hspg' ) );
		}
	}
