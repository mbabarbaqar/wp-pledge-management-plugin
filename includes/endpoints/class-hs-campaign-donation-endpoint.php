 ...
 * Donate endpoint.
 *
 * @package   Hspg/Classes/Hs_Campaign_Donation_Endpoint
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Campaign_Donation_Endpoint' ) ) :

	/**
	 * Hs_Campaign_Donation_Endpoint
	 *
	 * @since 1.5.0
	 */
	class Hs_Campaign_Donation_Endpoint extends Hs_Endpoint {
		...
		public function __construct() {
			 ...
			 */
			$this->force_https = apply_filters( 'hs_campaign_donation_endpoint_force_https', false );
		}
		...
		public function is_page( $args = array() ) {
			...
			return 'separate_page' != hs_get_option( 'donation_form_display', 'separate_page' );
		}
		...
		public function get_template( $template ) {
			 ...
			 */
			if ( ! hs_campaign_can_receive_donations( $campaign_id ) ) {
			 ...
			 */
			do_action( 'hs_is_donate_page', $campaign_id, $donation_id );
		...
		public function get_content( $content ) {
			...
			hs_template( 'content-donation-form.php', array() );
		...
		protected function is_donation_ready_campaign() {
			return hs_campaign_can_receive_donations( hs_get_current_campaign_id() );
		}
		...
		protected function is_invalid_donation( $donation_id ) {
			return ! hs_user_can_access_donation( $donation_id );
		}
