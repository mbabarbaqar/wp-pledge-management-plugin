 ...
 * Profile endpoint.
 *
 * @package   Hspg/Classes/Hs_Profile_Endpoint
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Profile_Endpoint' ) ) :
	 ...
	 * @since 1.5.0
	 */
	class Hs_Profile_Endpoint extends Hs_Endpoint {
		...
		public function get_page_url( $args = array() ) {
			$page = hs_get_option( 'profile_page', false );
		...
		public function is_descendent_page() {
			...
			$descendent_query_vars = apply_filters(
				'hs_profile_endpoint_descendent_query_vars',
		...
		public function nav_menu_object() {
			return hs_get_option( 'profile_page', false ) ? $this->get_nav_menu_object( __( 'Profile', 'hspg' ) ) : null;
		}
	}
