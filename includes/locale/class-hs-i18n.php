<?php
/**
 * Sets up translations for Hspg.
 *
 * @package   Hspg/Classes/Hs_i18n
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_i18n' ) ) :
	...
	class Hs_i18n {
		...
		private function __construct() {
			 ...
			 */
			$this->languages_directory = apply_filters( 'hs_languages_directory', 'hspg/i18n/languages' );
		...
		public function get_datepicker_format( $default = 'F d, Y' ) {
			 ...
			 */
			return apply_filters( 'hs_datepicker_date_format_decline_months', 'Y-m-d', $default );
		}
		...
		public function get_js_datepicker_format( $default = 'MM d, yy' ) {
			 ...
			 * @param string $default The format that would be used if decline months is off.
			 */
			return apply_filters( 'hs_datepicker_date_format_decline_months', 'yy-mm-dd', $default );
		}
