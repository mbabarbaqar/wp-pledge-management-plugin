<?php
/**
 * Hspg Utility Functions.
 *
 * Utility functions.
 *
 * @package   Hspg/Functions/Utility
 * @author    Eric Daams
 ...
 * @return int
 */
function hs_element_key_sort( $key, $a, $b ) {
 ...
 * @return int
 */
function hs_priority_sort( $a, $b ) {
	return hs_element_key_sort( 'priority', $a, $b );
}
 ...
 * @return int
 */
function hs_timestamp_sort( $a, $b ) {
	return hs_element_key_sort( 'time', $a, $b );
}
 ...
 */
function hs_is_func_disabled( $function ) {
 ...
 * @return boolean
 */
function hs_verify_nonce( $nonce, $action, $request_args = array() ) {
 ...
 * @return array
 */
function hs_array_subset( array $original_array, $subset_keys ) {
 ...
 * @return boolean
 */
function hs_sanitize_checkbox( $value = false ) {
 ...
 * @return string
 */
function hs_list_to_sentence_part( $list ) {
 ...
 * @return string|false
 */
function hs_sanitize_date( $date, $return_format = 'U' ) {
	global $wp_locale;
 ...
 * @return string
 */
function hs_get_query_placeholders( $count = 1, $placeholder = '%s' ) {
 ...
 * @return array
 */
function hs_get_pages_options( $args = array() ) {
