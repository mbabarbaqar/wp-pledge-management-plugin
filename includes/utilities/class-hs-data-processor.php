 ...
 *
 * @package   Hspg/Classes/Hs_Data_Processor
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Data_Processor' ) ) :
	...
	class Hs_Data_Processor {
		...
		protected function process_picture( $key ) {
			...
			if ( is_wp_error( $value ) ) {
				hs_get_notices()->add_errors_from_wp_error( $value );
				$value         = '';
				$this->invalid = true;
			}
		...
		protected function sanitize_datepicker( $value ) {
			...
			return hs_sanitize_date( $value, 'Y-m-d' );
		}
