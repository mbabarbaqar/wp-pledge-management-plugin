<?php
/**
 * Hspg navigation menu walker.
 *
 * @package   Hspg/Classes/Hs_Nav_Menu_Walker
 * @author    Eric Daams
...
/**
 * Create a set of Hspg-specific links for use in the Menus admin UI.
 *
 ...
 * @since 1.9.0
 */
class Hs_Walker_Nav_Menu_Checklist extends Walker_Nav_Menu {
