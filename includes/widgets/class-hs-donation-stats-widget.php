 ...
 *
 * @package     Hspg/Classes/Hs_Donation_Stats_Widget
 * @version     1.0.0
 * @author     HCS
...
if ( ! class_exists( 'Hs_Donation_Stats_Widget' ) ) :

	/**
	 * Hs_Donation_Stats_Widget class.
	 *
	 * @since   1.0.0
	 */
	class Hs_Donation_Stats_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'hs_donation_stats_widget',
				__( 'Donation Stats', 'hspg' ),
				array(
					'description' => __( 'Show off your donation statistics.', 'hspg' ),
		...
		public function widget( $args, $instance ) {
			...
			if ( ! array_key_exists( 'title', $view_args ) ) {
				$view_args['title'] = __( 'Donation Statistics', 'hspg' );
			}

			hs_template( 'widgets/donation-stats.php', $view_args );
		}
		...
		public function form( $instance ) {
			 ...
			 * @param 	Hs_Donation_Stats_Widget $this This widget instance.
			 */
			do_action( 'hs_donation_stats_widget_settings_bottom', $instance, $this );
		}
		...
		public function update( $new_instance, $old_instance ) {
			 ...
			 * @param   array $new_instance The updated settings.
		 	 ...
		 	 * @return  array
		 	 */
			return apply_filters( 'hs_donation_stats_widget_update_instance', $instance, $new_instance, $old_instance );
		}
	}
