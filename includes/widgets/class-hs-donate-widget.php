 ...
 *
 * @package     Hspg/Classes/Hs_Donate_Widget
 * @version     1.0.0
 * @author     HCS
...
if ( ! class_exists( 'Hs_Donate_Widget' ) ) :
	 ...
	 * @since   1.0.0
	 */
	class Hs_Donate_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'hs_donate_widget',
				__( 'Campaign Donation', 'hspg' ),
				array(
					'description' => __( 'Display a donation widget.', 'hspg' ),
		...
		public function widget( $args, $instance ) {
			...
			hs_template( 'widgets/donate.php', array_merge( $args, $instance ) );
		}
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'hspg' ) ?>
					<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
				</label>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'campaign_id' ); ?>"><?php _e( 'Campaign:', 'hspg' ) ?>
					<select name="<?php echo $this->get_field_name( 'campaign_id' ) ?>">
						<option value="current"><?php _e( 'Campaign currently viewed', 'hspg' ) ?></option>
						<optgroup label="<?php _e( 'Specific campaigns', 'hspg' ) ?>">
