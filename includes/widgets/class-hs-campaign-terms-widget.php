 ...
 *
 * @package  Hspg/Widgets/Hs_Campaign_Terms_Widget
 * @category Class
 * @author   Eric Daams
 * @since    1.0.0
 * @version  1.5.4
...
if ( ! class_exists( 'Hs_Campaign_Terms_Widget' ) ) :

    /**
     * Hs_Campaign_Terms_Widget class.
     *
     * @since   1.0.0
     */
    class Hs_Campaign_Terms_Widget extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                'hs_campaign_terms_widget',
                __( 'Campaign Categories / Tags', 'hspg' ),
                array(
                    'description' => __( 'Displays your Hspg campaign categories or tags.', 'hspg' ),
        ...
        public function widget( $args, $instance ) {
            ...
            hs_template( $template, $view_args );
        }
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'taxonomy' ) ?>"><?php _e( 'Taxonomy', 'hspg' ) ?></label>
                <select name="<?php echo $this->get_field_name('taxonomy' ) ?>" id="<?php echo $this->get_field_id( 'taxonomy' ) ?>">
                    <option value="campaign_category" <?php selected( 'campaign_category', $taxonomy ) ?>><?php _e( 'Categories', 'hspg' ) ?></option>
                    <option value="campaign_tag" <?php selected( 'campaign_tag', $taxonomy ) ?>><?php _e( 'Tags', 'hspg' ) ?></option>
                </select>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'show_count' ) ?>"><?php _e( 'Show count:', 'hspg' ) ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'hide_empty' ) ?>"><?php _e( 'Hide empty:', 'hspg' ) ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'dropdown' ) ?>"><?php _e( 'Display as dropdown:', 'hspg' ) ?></label>
