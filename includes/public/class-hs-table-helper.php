 ...
 *
 * @package   Hspg/Classes/Hs_Table_Helper
 * @version   1.5.0
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Table_Helper' ) ) :
	...
	class Hs_Table_Helper {
		...
		public function render() {
			...
			hs_template( 'tables/table.php', array( 'helper' => $this ) );
		}
		...
		public function render_row( $row_data ) {
			hs_template( 'tables/row.php', array( 'data' => $row_data, 'columns' => $this->columns ) );
		}
