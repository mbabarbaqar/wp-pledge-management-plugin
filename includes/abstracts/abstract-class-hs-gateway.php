 ...
 *
 * @version     1.0.0
 * @package     Hspg/Classes/Hs_Gateway
 * @author     HCS
...
if ( ! class_exists( 'Hs_Gateway' ) ) :
	 ...
	 * @since   1.0.0
	 */
	abstract class Hs_Gateway implements Hs_Gateway_Interface {
		...
		public function default_gateway_settings() {
			return array(
				...
				'label'           => array(
					'type'     => 'text',
					'title'    => __( 'Gateway Label', 'hspg' ),
					'help'     => __( 'The label that will be shown to donors on the donation form.', 'hspg' ),
					'priority' => 4,
		...
		public function get_settings() {
			return hs_get_option( 'gateways_' . $this->get_gateway_id(), array() );
		}
		...
		public function get_label() {
			return hs_get_option( 'label', $this->get_default_label(), $this->get_settings() );
		}
		...
		public function get_value( $setting ) {
			...
			return hs_get_option( $setting, $default, $this->get_settings() );
		}
		...
		public function supports( $feature ) {
			...
			return apply_filters( 'hs_payment_gateway_supports', $supported, $feature, $this );
		}
		...
		public function get_credit_card_fields() {
			...
			return apply_filters(
				'hs_credit_card_fields',
				array(
					'cc_name'       => array(
						'label'     => __( 'Name on Card', 'hspg' ),
						'type'      => 'text',
						'required'  => true,
						'priority'  => 2,
						'data_type' => 'gateway',
		...
		public function requires_credit_card_form() {
			hs_get_deprecated()->deprecated_function( __METHOD__, '1.3.0', 'Hs_Gateway::supports( \'credit-card\' )' );
