...
if ( ! class_exists( 'Hs_DB' ) ) :
	...
	abstract class Hs_DB {
		...
		public function insert( $data, $type = '' ) {
			...
			do_action( 'hs_pre_insert_' . $type, $data );
			...
			do_action( 'hs_post_insert_' . $type, $wpdb->insert_id, $data );
