 ...
 *
 * @package   Hspg/Classes/Hs_Endpoint
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Endpoint' ) ) :
	 ...
	 * @since 1.5.0
	 */
	abstract class Hs_Endpoint implements Hs_Endpoint_Interface {
		...
		public function get_nav_menu_object( $title ) {
			...
			$menu_object->classes          = array( 'hs-menu' );
