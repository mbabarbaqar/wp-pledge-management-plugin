...
?>
<div id="hs-campaign-description-metabox-wrap" class="hs-metabox-wrap">
	<label class="screen-reader-text" for="campaign_description"><?php echo $campaign_description ?></label>
	<textarea name="_campaign_description" id="campaign_description" tabindex="" rows="10" placeholder="<?php _e( 'Enter a short description of your campaign', 'hspg' ); ?>"><?php echo $campaign_description ?></textarea>
</div>
