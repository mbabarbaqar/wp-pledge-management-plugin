<?php
/**
 * Hspg Meta Box Helper
 *
 * @package   Hspg/Classes/Hs_Meta_Box_Helper
 * @author    Eric Daams
...
if ( ! class_exists( 'Hs_Meta_Box_Helper' ) ) :
	...
	class Hs_Meta_Box_Helper {
		 ...
		 * @var   string
		 */
		protected $nonce_name = '_hs_nonce';
		 ...
		 */
		public function __construct( $nonce_action = 'hspg' ) {
		...
		public function display( $view, $view_args ) {
			...
			do_action( 'hs_metabox_before', $view, $view_args );

			hs_admin_view( $view, $view_args );

			do_action( 'hs_metabox_after', $view, $view_args );
		}
